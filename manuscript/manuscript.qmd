...
By using improved methods for model evaluation, we can greater confidence that the inferences of student proficiency we draw from DCMs are valid indicates of the students' knowledge and skills.
